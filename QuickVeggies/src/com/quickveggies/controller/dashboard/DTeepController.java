									...
									if (buyerDeal != null && !buyerDeal.isTotalLine()) {
										...
										hLink.setOnAction(new EventHandler<ActionEvent>() {
											...
											public void handle(ActionEvent event) {
												...
												System.out.println("buyerDeal  -"+buyerDeal);
												System.out.println("suppDeal  -"+suppDeal);
												System.out.println("getSupplierCharge(buyerDeal)  -"+getSupplierCharge(buyerDeal));
												
												
												TeepDetailController controller = new TeepDetailController(buyerDeal,
														suppDeal, getSupplierCharge(buyerDeal));
												DashboardController.showPopup("/fxml/teepdetails.fxml",
														"Teep Difference Detail", controller);
											}
										});
										setGraphic(hLink);
									}
